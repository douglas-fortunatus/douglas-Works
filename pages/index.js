...
const Home = () => {
    ...
    const copyText = () => {
        ...
        textField.innerText = 'fortunatusdouglas@gmail.com';
    ...
    return(
        <Layout>
            <PageSection color={color}>
                <PageWrapper>
                    <article>
                        <h1 data-text="I'm Douglas Fortunatus" className="intro__text">
                            <mark className="mark"> I&apos;m Douglas Fortunatus </mark>
                        </h1>
...
const PageSection = styled.div`
    ...
    .intro__text {
        ...
        &::after {
            ...
            animation: nois📧e-anim 2s infinite linear alternate-reverse;
        }
